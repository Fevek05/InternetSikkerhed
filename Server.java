...
public class Server extends IpMachine
{
    ...
    private String password; //skal  nok laves til en samling af passwords som er unikke for de enkelte klienter/users
    ...
    public IpMessage receive(IpMessage message)
    {
        ...
        {
            getInternet().transmit(new IpMessage(this.getId(), message.getSender(), "Du har nu adgang til alle mine hemmeligheder"));
        }
