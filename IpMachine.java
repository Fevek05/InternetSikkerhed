...
public class IpMachine {
    ...
    // The IpMachine has to be be connected to/associated with an internet when
    // created
    {
    ...
    public IpMessage receive(IpMessage message) {
        // put your code here
        IpMessage transmittedMessage = message.clone(); // For at sikre afsenderen ikke kan se hvordan modtageren ændrer
                                                        // på message.
